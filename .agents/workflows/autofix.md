...
> - Follow `AGENTS.md` (repo root) and the repo’s coding rules (e.g. `.agents/rules/general-programming-principles.mdc`, or the path specified by `AGENTS.md`).
...
Read (no edits):
- `AGENTS.md`
- Coding principles file (e.g. `.agents/rules/general-programming-principles.mdc`, or locate per `AGENTS.md`)
