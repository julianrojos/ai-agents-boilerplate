...
inputs:
  - name: target
    type: string
    required: false
    default: "Current interface, design, or files in scope."
    description: "Interface, flow, design, or file set to evaluate."
outputs:
  - name: audit_report
    type: report
    description: "Prioritized usability findings, severity ratings, and recommended improvements."
license: MIT
metadata:
  author: wondelai
  version: "1.4.0"
